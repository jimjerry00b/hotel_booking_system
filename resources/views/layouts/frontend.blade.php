...
<body>
    @if (Session::has('message'))
        <div class="class_hide alert alert-success bg-success text-light border-0 alert-dismissible fade show" role="alert" style="width: fit-content; position: fixed; right: 15px; top: 15px; z-index: 1;">
            {{ Session::get('message') }}
        <button type="button" class="btn" data-bs-dismiss="alert" aria-label="Close">X</button>
    @endif

    @if (Session::has('error'))
        <div class="alert alert-danger custom_alert" role="alert" style="width: fit-content; position: fixed; right: 15px; top: 15px; z-index: 1;">
            {{ Session::get('error') }}
        <button type="button" class="btn" data-bs-dismiss="alert" aria-label="Close">X</button>
    @endif
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="header-configure-area">
            <div class="language-option">
                <img src="{{ asset('assets/frontend/img/flag.jpg') }}" alt="">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <ul class="tn-left">
                            ...
                            <li><i class="fa fa-envelope"></i> info.colorlib@gmail.com</li>
                            @if(Auth::user())
                                <li><i class="fa fa-envelope"></i>{{ Auth::user()->name }}</li>
                            @endif
                        </ul>
                    </div>
                    <div class="col-lg-6">
    ...
    function hide_notification(){
        document.querySelectorAll(".class_hide").forEach(function(element) {
